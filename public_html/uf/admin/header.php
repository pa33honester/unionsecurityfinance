                        ...
                        <div class="nk-sidebar-content">
                            <div class="nk-sidebar-menu">
                                <ul class="nk-menu">
                                    ...
                                    <li class="nk-menu-item">
                                        <a href="paypal?action=withrawal_requests" class="nk-menu-link">
                                            <span class="nk-menu-icon">
                                                <em class="icon fab fa-cc-paypal"></em> <!-- PayPal icon from Font Awesome -->
                                            </span>
                                            <span class="nk-menu-text">Paypal Withdrwals</span>
                                            <?php 
                                                $query = $conn->query("SELECT * FROM paypal_withdrawals WHERE status = 'pending'");
                                                $paypal_withdrawal_requests = mysqli_num_rows($query);
                                                if($paypal_withdrawal_requests > 0) 
                                                    echo '<span class="badge badge-primary">'. $paypal_withdrawal_requests . '</span>'; 
                                            ?>
                                        </a>
                                    </li>
                                    <li class="nk-menu-item">
