                        ...
                        $(document).ready(function() {
                            $('.UpdateBtn<?php echo $coinid ?>').click(function(e) {
                                ...
                                $.ajax({
                                    ...
                                    data: {
                                        "wallet<?php echo $coinid ?>": wallet<?php echo $coinid ?>,
                                    },
                                    success: function(data) {
                                    ...
                                    <div class="modal fade" tabindex="-1" id="approve<?php echo $id ?>">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <strong>You are about to Approve <?php echo $rows['coin'];
                                                                                        echo " ";
                                                                                        echo $rows['amount'] ?> Deposit Made by <?php echo "" . $user['firstname'] . " " . $user['lastname'] . " " . $user['middlename'] . ""; ?> </strong>
                                                </div>
                                                <form action="" method="post">
                    ...
                    <div class="modal fade" tabindex="-1" id="reject<?php echo $id ?>">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <strong>You are about to Reject <?php echo $rows['coin'];
                                                                    echo " ";
                                                                    echo $rows['amount'] ?> Deposit Made by <?php echo "" . $user['firstname'] . " " . $user['lastname'] . " " . $user['middlename'] . ""; ?> </strong>
                                </div>
                                <form action="" method="post">
                        ...
                        <div class="modal fade" tabindex="-1" id="approve<?php echo $id ?>">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <strong>You are about to Delete <?php echo $rows['coin'];
                                                                        echo " ";
                                                                        echo $rows['amount'] ?> Deposit Made by <?php echo "" . $user['firstname'] . " " . $user['lastname'] . " " . $user['middlename'] . ""; ?> </strong>
                                    </div>
                                    <form action="" method="post">
