...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['firstname'])) {
    ...
    $sql = "INSERT INTO users (
        firstname, middlename, lastname, countryId, stateId, cityId, zipcode, dob, address, phone, email,
        next_of_kin, next_of_kin_phone, next_of_kin_relationship,
        accountnumber, accounttype, usercurrency, accountbalance, imf, cot, secretCode, password
    ) VALUES (
        '$firstname','$middlename','$lastname','$countryId','$stateId','$cityId','$zipcode','$dob','$address','$phone','$email',
        '$next_of_kin','$next_of_kin_phone','$next_of_kin_relationship',
        '$accountnumber','$accounttype','$usercurrency','$accountbalance','$imf','$cot','$secretCode','$password'
...
var next_of_kin_relationship = $('input[name="next_of_kin_relationship"]').val();
      ...
      $.ajax
       ...
       "accountnumber": accountnumber, "accounttype": accounttype, "usercurrency": usercurrency,
