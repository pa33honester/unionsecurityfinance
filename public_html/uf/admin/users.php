    ...
    <div class="nk-block nk-block-lg">
                ...
                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                    ...
                    <tbody>
                     ...
                     <em class="icon ni ni-user text-success"></em>
                            ...
                            } elseif ($userdetails['status'] == 'held') {
                                $stat = '<span class="tb-status text-warning">On Hold</span>';
                     ...
                     <em class="icon ni ni-user-cross-fill text-danger"></em>
                                ...
                                $holdBtn = '<a data-toggle="modal" data-target="#unholdAccount' . $userid . '" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Unhold User">
                     <em class="icon ni ni-user text-success"></em>
                      </a>';
                            } else {
                     ...
                     <em class="icon ni ni-user-cross-fill text-danger"></em>
                                ...
                                $holdBtn = '<a data-toggle="modal" data-target="#holdAccount' . $userid . '" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Hold User">
                     <em class="icon ni ni-user text-warning"></em>
                      </a>';
                            }
        ...
        ';
                        ...
                        ?>
                            ...
                            <div class="modal fade" tabindex="-1" id="holdAccount<?php echo $userid ?>">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <a href="#" class="close text-white" data-dismiss="modal" aria-label="Close">
                                            <em class="icon ni ni-cross"></em>
                                        ...
                                        <div class="modal-header text-white" style="background-color:#033d75; color: white;">
                                            <h5 class="modal-title">Hold User Account</h5>
                                        </div>
                                        <div class="modal-body">
                                            <strong>You are about to put <?php echo $fullname ?>'s account on hold. The user will be restricted from performing certain actions until unheld.</strong>
                                        </div>
                                        <div class="holdResult<?php echo $userid ?>"></div>
                                        <div class="modal-footer">
                                            <form action="" method="post">
                                                <input type="hidden" name="hold<?php echo $userid ?>" value="<?php echo $userid ?>" id="hold<?php echo $userid ?>">
                                                <button type="submit" class="btn btn-primary btn-sm holdBtn<?php echo $userid ?>">Hold</button>
                                                <button class="btn btn-danger btn-sm" data-dismiss="modal">Cancel</button>
                                            </form>
                                        </div>
                                    </div>
                            ...
                            <script type="text/javascript">
                                $(document).ready(function() {
                                    $('.holdBtn<?php echo $userid ?>').click(function(e) {
                                        e.preventDefault();
                                        var hold<?php echo $userid ?> = $('#hold<?php echo $userid ?>').val();
                                        $.ajax({
                                            type: "POST",
                                            url: "../scripts/restriction.php?id=<?php echo $userid ?>&action=hold",
                                            data: {
                                                "hold<?php echo $userid ?>": hold<?php echo $userid ?>,
                                            },
                                            success: function(data) {
                                                $('.holdResult<?php echo $userid ?>').html(data);
                                            }
                                        });
                                    });
                                });
                            ...
                            <!--- Unhold User account Modal------->
                            <div class="modal fade" tabindex="-1" id="unholdAccount<?php echo $userid ?>">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <a href="#" class="close text-white" data-dismiss="modal" aria-label="Close">
                                            <em class="icon ni ni-cross"></em>
                                        ...
                                        <div class="modal-header text-white" style="background-color:#033d75; color: white;">
                                            <h5 class="modal-title">Unhold User Account</h5>
                                        </div>
                                        <div class="modal-body">
                                            <strong>You are about to remove the hold on <?php echo $fullname ?>'s account. The user will regain normal access.</strong>
                                        </div>
                                        <div class="unholdResult<?php echo $userid ?>"></div>
                                        <div class="modal-footer">
                                            <form action="" method="post">
                                                <input type="hidden" name="unhold<?php echo $userid ?>" value="<?php echo $userid ?>" id="unhold<?php echo $userid ?>">
                                                <button type="submit" class="btn btn-primary btn-sm unholdBtn<?php echo $userid ?>">Unhold</button>
                                                <button class="btn btn-danger btn-sm" data-dismiss="modal">Cancel</button>
                                            </form>
                                        </div>
                                    </div>
                            ...
                            <script type="text/javascript">
                                $(document).ready(function() {
                                    $('.unholdBtn<?php echo $userid ?>').click(function(e) {
                                        e.preventDefault();
                                        var unhold<?php echo $userid ?> = $('#unhold<?php echo $userid ?>').val();
                                        $.ajax({
                                            type: "POST",
                                            url: "../scripts/restriction.php?id=<?php echo $userid ?>&action=unhold",
                                            data: {
                                                "unhold<?php echo $userid ?>": unhold<?php echo $userid ?>,
                                            },
                                            success: function(data) {
                                                $('.unholdResult<?php echo $userid ?>').html(data);
                                            }
                                        });
                                    });
                                });
