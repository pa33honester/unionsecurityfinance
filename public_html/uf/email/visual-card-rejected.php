                ...
                <table class="email-body_inner" align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                  ...
                  <tr>
                    <td class="content-cell">
                      ...
                      <h2>Dear '.$fullname.',</h2>
                        <p>Your Visual Card request could not be approved at the moment.<p>
                        <!-- Action -->
                       <p>For more information why your Application was declined, Kindly <a href="maito:'.$siteemail.'">contact</a> our live customer care representative.<p>
                        <!-- Sub copy -->
