<?php
$otpBody='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <p>
                          <b>Location: '.getLocation().' <br>
                          <b>IP Address: '.$ipa.'</b><br>
                          <b>Browser: '.$browser.'</b>
                        </p>
                            ...
                            <td align="center">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center">
                                   <center>
                                   <h1 style="letter-spacing:20px; text-align:center;">'.$auth_code.'</h1>
                                   </center>
                                  </td>
                                </tr>
                              </table>
