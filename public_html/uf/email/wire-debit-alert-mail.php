<?php
    ...
    $j = $_SESSION['recipientDetailsB'];
            ...
            $addressB = "$city, $state, $zipcode, $country";
    $query4 = $conn->query("SELECT * FROM wire WHERE id = '$recipientid'");
                ...
                <table class="email-body_inner" align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                  ...
                  <tr>
                    <td class="content-cell">
                      ...
                      <h2>Dear '.$fullnameB.',</h2>
                        <p>A Cross-border transfer was initiated for your account by '.$fullname.'. Kindly wait for an official confirmation from your bank prior to the completion of this transfer which usually take 2-3 working days.</p>
                        <!-- Action -->
                            ...
                            <td align="center">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center">
                                   <center> 
                                    <h2 style=" text-align:center;">Total Amount Sent</h2>
                        ...
                        <p><b>Details of the transaction are shown below;</b></p>
                            <b>Bank name: '.$bankname.'</b><br>
                             <b>Account Number: '.$accountnumber.'</b><br>
                             <b>Account Name: '.$accountholder.'</b><br>
                             <b>Description: '.$description.'</b><br>
                             <b>Total Amount Sent: '.$money.' '.number_format($amount).'</b><br>
                ...
                <table class="email-body_inner" align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                      <h2>Dear '.$fullname.',</h2>
                        <p>Your account have been Debited.</p>
                        <!-- Action -->
                        <table class="body-action" align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td align="center">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center">
                                   <center>
                                     <h2 style=" text-align:center;">Total Amount</h2>
                                   <h1 style=" text-align:center;"> '.$money.' '.number_format($amount).'</h1>
                                   </center>
                                  </td>
                                </tr>
                        ...
                        <b>Details of the transaction are shown below;</b><br>
                             <b>Account Number: '.$accountnumber.'</b><br>
                            <b>Account Name: '.$fullname.'</b><br>
                             <b>Description: '.$description.'</b><br>
                             <b>Total Amount: '.$money.' '.$amount.'</b><br>
                             <b>Date: '.date("d M Y, H:i a").'</b><br>
                             <b>Available Balance: '.$money.' '.number_format($accountbalance).'</b>
                        <!-- Sub copy -->
                        <table class="body-sub" role="presentation">
                          <tr>
                            <td>
