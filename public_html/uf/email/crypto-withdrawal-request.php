...
$mail->Subject = "Crypto Withdrawal Notification";
$mail->isHTML(true);
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            ...
            <tr>
              <td class="email-masthead">
                ...
                '.$shortname.' Crypto Withdrawal request
              </a>
              </td>
            </tr>
            <!-- Email Body -->
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                       <h1>Hi '.$fullname.',</h1>
                        <p>You made a Withdrawal request from your '.$sitename.' Crypto Asset, Kindly hold on while your request is being processed.
                          </p>
                          <p>
                           <b><h2>Amount:  '.$money.' '.$amount.'</h2>
                           Destination: '.$destination.'</b>
                           Requested on: '.$dateCreated.'<br>
                          </p>
                      </div>
                    </td>
                  </tr>
