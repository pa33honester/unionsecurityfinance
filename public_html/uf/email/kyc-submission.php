                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                       <h1>Dear'.$fullname.',</h1>
                        <strong>Your Identity has been submitted to '.$sitename.'. 
                        <br>
                          </strong>
                          <p>
                          You will receive an email when the system starts to review Your Application, Approves it, or requests for additional information.
                          </p>
                        <!-- Sub copy -->
