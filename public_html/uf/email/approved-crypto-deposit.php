...
$mail->Subject = "Crypto Deposit Confirmation";
$mail->isHTML(true);
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            ...
            <tr>
              <td class="email-masthead">
                ...
                '.$shortname.' Crypto  Deposit Confirmation
              </a>
              </td>
            </tr>
            <!-- Email Body -->
                    ...
                    <td class="content-cell">
                      <div class="f-fallback">
                       <h1>Dear '.$user['firstname'].' '.$user['middlename'].' '.$user['lastname'].',</h1>
                        <p>Your Deposit of '.$coin.' '.$amount.' Has been confirmed on the blockchain Network.
                        <br>
                        The Deposited Crypto Asset is now available in your '.$shortname.' '.$coin.' Wallet.
                          </p>
                          <p>
                        <!-- Sub copy -->
