...
$mail->Subject = "Crypto Deposit Notification";
$mail->isHTML(true);
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                       <h1>Hi '.$fullname.',</h1>
                        <p>Your Crypto Asset Deposit has been recorded successfully and currently undergoing confirmation. You will receive an authomatic notification once your transaction was confirmed on the blockchain Network. This usually take upto 15 minutes.
                          </p>
                          <p>
                           <b><h2>Amount:  '.$coin.' '.$amount.'</h2>
                           Deposit Address: '.$address.'</b>
                           Deposited on: '.$dateCreated.'<br>
                          </p>
                      </div>
                    </td>
                  </tr>
