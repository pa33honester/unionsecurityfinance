<?php
$cardBody = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                ...
                <table class="email-body_inner" align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                  ...
                  <tr>
                    <td class="content-cell">
                      ...
                      <h2>Dear '.$fullname.',</h2>
                        <p>Congratlations! your Visual card application has been approved. Your card is now ready for you to shop with your favorite websites and enjoy seamless online transactions.<p>
                        <!-- Action -->
                       <p>You can fund and mange your Visual card through our online banking channel.<p>
                        <!-- Sub copy -->
