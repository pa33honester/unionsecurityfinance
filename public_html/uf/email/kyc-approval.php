                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                       <h1>Dear'.$fullname.',</h1>
                        <strong>Congratulations!, Your Identity has been Verified. 
                        <br>
                          </strong>
                          <p>
                          Your submitted documents has been reviewed and accepted. YOu can now enjoy seamless transactions and other benefits '.$shortname.'.<br>
                          </p>
                          <p>
                           '.$msg.'.<br>
                          </p>
