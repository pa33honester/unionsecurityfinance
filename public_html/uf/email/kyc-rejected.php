<?php
$kycBody='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                       <h1>Dear'.$fullname.',</h1>
                        <strong>Looks like your KYC Verification has failed. Do you require assistance regarding this issue, kindly write to '.$siteemail.'. 
                        <br>
                          </strong>
                          <p>
                          KYC documents are necessary for us to know our customers better and give them the best possible service. Kindly Update your KYC information at the earliest to avoid baring your account.<br>
                          </p>
                          <p>
                           '.$msg.'.<br>
                          </p>
