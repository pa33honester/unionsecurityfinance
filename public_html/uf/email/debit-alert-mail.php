<?php
  ...
  <body>
                      ...
                      <h2>Dear '.$fullname.',</h2>
                        ...
                        <p><b>Details of the transaction are shown below;</b></p>
                            ...
                            <b>Account Name: '.$fullname.'</b><br>
                             <b>Description: '.$_SESSION['description'].'</b><br>
                             <b>Total Amount: '.$money.' '.$amount.'</b><br>
                             <b>Date: '.date("d M Y, H:i a").'</b><br>
                             <b>Available Balance: '.$money.' '.$accountbalance.'</b>
                        <!-- Sub copy -->
    ...
    {
     echo "<script>window.location.href='../personal-banking/transaction-successful?transferToken=".$_SESSION['transaction_session']."'; </script>";
             unset($_SESSION["bankname"]);
             unset($_SESSION["routineNumber"]);
             unset($_SESSION["accountnumberB"]);
             unset($_SESSION["accountholder"]);
