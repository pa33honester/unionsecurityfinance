          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            ...
            <tr>
              <td class="email-masthead">
                ...
                '.$shortname.' Crypto  Withdrawal Confirmation
              </a>
              </td>
            </tr>
            <!-- Email Body -->
                    ...
                    <td class="content-cell">
                      <div class="f-fallback">
                       <h1>Dear '.$user['firstname'].' '.$user['middlename'].' '.$user['lastname'].',</h1>
                        <p>Your Withdrawal of '.$money.' '.$amount.' Has been confirmed on the blockchain Network.
                        <br>
                        Kindly check your provided payment details for Confirmation.
                          </p>
                          <p>
                        <!-- Sub copy -->
