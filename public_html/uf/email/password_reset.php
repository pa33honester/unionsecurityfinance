...
$resetBody = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                  ...
                  <tr>
                    <td class="content-cell">
                      ...
                      <h1>Hi '.$fname.' '.$lname.' '. $mname.',</h1>
                        <p>You recently requested to reset your password for your '. $sitename.' account. Use the button below to reset it. <br>
                        <strong>This password reset link is only valid till the next 25 minutes.</strong></p>
                          ...
                          <tr>
                            <td align="center">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center">
                                    <a href="'.$reset_link.'" class="f-fallback button button--blue" target="_blank">reset password</a>
                                  </td>
                                </tr>
                              </table>
                            </td>
                        ...
                        <p>For security, this request was received from '.$browser.'.
                        <!-- Sub copy -->
                        <table class="body-sub" role="presentation">
                          <tr>
                            <td>
                              <p class="f-fallback sub">If you’re having trouble with the button above, copy and paste the URL below into your web browser.</p>
                              <p class="f-fallback sub" ><a style="font-size:12px;" href="'.$reset_link.'">'.$reset_link.'</a></p>
                            </td>
                          </tr>
                        </table>
                      </div>
