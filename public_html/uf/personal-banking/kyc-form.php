 ...
 <!-- content @s -->
                                    ...
                                    <div class="card card-bordered">
                                        <div class="nk-kycfm">
                                            ...
                                            <div class="nk-kycfm-content">
                                                ...
                                                <form action="../scripts/auth?action=kycApply" method="post" id="kycForm" enctype="multipart/form-data">
                                                <div class="row g-4">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg" name="firstname" id="firstname" value="<?php echo$firstname ?>" required>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg" name="lastname" id="lastname" value="<?php echo$lastname ?>" required>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="email" name="email" id="email" value="<?php echo$email ?>" readonly class="form-control form-control-lg" required>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="tel" name="phone" id="phone" value="<?php echo$phone ?>" class="form-control form-control-lg" required>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" id="dob" name="dob" value="<?php echo$dob ?>" class="form-control form-control-lg date-picker" required>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" id="accountnumber" name="accountnumber" value="<?php echo$accountnumber ?>" class="form-control form-control-lg" required>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                </div><!-- .row -->
                                            ...
                                            <div class="nk-kycfm-head">
                                                ...
                                                <div class="nk-kycfm-title">
                                                    ...
                                                    <p class="sub-title">Your address information required for identification</p>
                                                </div>
                                            </div><!-- .nk-kycfm-head -->
                                            <div class="nk-kycfm-content">
                                                <div class="nk-kycfm-note">
                                                ...
                                                <div class="row g-4">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg" id="address1" name="address1" value="<?php echo$address ?>" required>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" name="city" id="city" value="<?php echo$city ?>" class="form-control form-control-lg" required>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" id="state" name="state" value="<?php echo$state ?>" class="form-control form-control-lg" required>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" id="nationality" name="nationality" value="<?php echo$country ?>" class="form-control form-control-lg date-picker-alt" required>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" name="zipcode" id="zipcode" value="<?php echo$zipcode ?>" class="form-control form-control-lg" required>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                </div><!-- .row -->
                                            ...
                                            <div class="nk-kycfm-content">
                                                ...
                                                <ul class="nk-kycfm-control-list g-3">
                                                    <li class="nk-kycfm-control-item">
                                                        <input class="nk-kycfm-control" type="radio" name="id_type" value="passport" id="passport" data-title="Passport" checked required>
                                                    ...
                                                    <li class="nk-kycfm-control-item">
                                                        <input class="nk-kycfm-control" type="radio" value="national-id" name="id_type" id="national-id" data-title="National ID" required>
                                                    ...
                                                    <li class="nk-kycfm-control-item">
                                                        <input class="nk-kycfm-control" type="radio" value="driver-licence" name="id_type" id="driver-licence" data-title="Driving License" required>
                                               ...
                                               <div class="form-group col-md-6">
                                                <label class="form-label" for="customFileLabel">Front</label>
                                                  <div class="col-md-12 p-0">
                                                 <img class="img-responsive" id="output_imageB" src="../images/id-front.png" style="width:100%; height:130px">
                                                 </div>
                                                 <p class="clear-fix"></p>
                                             <div class="form-control-wrap">
									        <div class="custom-file">
									            <input type="file" name="front" class="custom-file-input" id="fileTag" accept="image/*" onchange="preview_imageB(event)" required>
									            <label class="custom-file-label" for="customFile">Choose file</label>
																					        </div>
												    </div>
												</div>
												<div class="form-group col-md-6">
												    <label class="form-label" for="customFileLabel">Back</label>
												    <div class="col-md-12 p-0">
												    <img class="img-responsive" id="output_image" src="../images/id-back.png" style="width:100%; height:130px">
												   </div>
												   <p class="clear-fix"></p>
												    <div class="form-control-wrap">
												        <div class="custom-file">
												            <input type="file" class="custom-file-input" name="back" accept="image/*" onchange="preview_image(event)" required>
												            <label class="custom-file-label" for="customFile">Choose file</label>
												        </div>
												    </div>
												</div>
                                            ...
                                            <div class="nk-kycfm-footer">
                                                <div class="form-group">
                                                    <div class="custom-control custom-control-xs custom-checkbox">
                                                        ...
                                                        <label class="custom-control-label" for="tc-agree">I Have Read The <a href="privacy">Terms Of Condition</a> And <a href="privacy">Privacy Policy</a></label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="custom-control custom-control-xs custom-checkbox">
                                                ...
                                                <div class="nk-kycfm-action pt-2">
                                                    <button type="submit" class="btn btn-lg btn-primary" id="btn">Submit</button>
                                                </div>
                                            </div><!-- .nk-kycfm-footer -->
                                        </div>
                                    </form>
        ...
        <script src="../js/jquery.min.js"></script>
         <script type="text/javascript">
		    ...
		    e.preventDefault();
		    $.ajax({
        	url: "../scripts/auth?action=kycApply",
			type: "POST",
