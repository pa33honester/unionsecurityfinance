                                ...
                                <div class="nk-block-head nk-block-head-lg wide-sm mx-auto">
                                    <div class="nk-block-head-content text-center">
                                        ...
                                        <div class="nk-block-des">
                                            ...
                                            <p class="lead">We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.</p>
                                            <p class="text-soft ff-italic">Last Update: Nov 12, 2020</p>
                                        </div>
                                    </div>
                                </div><!-- .nk-block-head -->
                                <div class="nk-block">
...
<li>
<p><b>Company</b> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to <?php echo$shortname ?> LLC, <?php echo$siteaddress ?></p>
</li>
<li>
...
<li>
<p><b>Country</b> refers to: <?php echo$sitecountry ?></p>
</li>
<li>
...
<li>
<p><b>Website</b> refers to <?php echo$sitename ?>, accessible from <a href="<?php echo$_SERVER['HTTP_HOST'] ?>" rel="external nofollow noopener" target="_blank"><?php echo$_SERVER['HTTP_HOST'] ?></a></p>
</li>
<li>
...
<ul>
<li>By email: <?php echo$siteemail ?></li>
</ul>   
                                    </div><!-- .card -->
                                </div><!-- .nk-block -->
                            </div><!-- .content-page -->
