                            ...
                            <div class="buysell wide-xs m-auto">
                                ...
                                <div class="buysell-block">
                                    <form action="#" method="post" class="buysell-form">
                                        <div class="verifyWireResult"></div>
                                        ...
                                        <div class="buysell-field form-group">
                                            ...
                                            <div class="form-control-group">
                                                <input type="number" class="form-control form-control-lg form-control-number" id="otp" name="otp" name="otp" placeholder="******">
                                        ...
                                        <div class="buysell-field form-action">
                                            <button type="submit" class="btn btn-lg btn-block btn-primary verifyWire" id="btn">Verify OTP</a>
                                        </div><!-- .buysell-field -->
