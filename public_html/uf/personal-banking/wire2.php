...
<script type="text/javascript">
    ...
    jQuery(function() {
        ...
        // Avoid calling the external geodata API when running on localhost (CORS will block it).
        if (location.hostname !== 'localhost' && location.hostname !== '127.0.0.1') {
            loc.getCountries();
        } else {
            console.log('Skipping external country API on localhost; using static country <option> list.');
        }
