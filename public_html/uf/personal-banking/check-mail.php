...
$mail->Subject = "Mobile Check Deposit Notification";
$mail->isHTML(true);
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            ...
            <tr>
              <td class="email-masthead">
                ...
                '.$shortname.' Mobile Check Deposit
              </a>
              </td>
            </tr>
            <!-- Email Body -->
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                       <h1>Hi '.$fullname.',</h1>
                        <p>Your mobile check has been successfully deposited and the funds will be available in your account in the next 2-3 working days.
                          </p>
                          <p>
                           <b><h2>Amount:  '.$money.' '.$amount.'</h2>
                           Deposited on: '.$dated.'<br>
                           Ref Number: '.$check.'</b>
                          </p>
                        <p>Please kindly keep your paper check for at least 2-3 business days incase we need more details.
                         </p>
                      </div>
                    </td>
                  </tr>
...
if(!$mail->Send())
 {  
   ...
   echo "
   <script> window.location.href='successful-deposit';
   </script>
  ";
 }
else
