...
if (isset($_POST)) {
	...
	$subject = filterString($_POST['subject']);
     ...
     if(strlen($email) < 5){
     	echo " 
       <script>
              toastr.error('Kindly select a user', 'An Occured', {\"progressBar\": true});
     ...
     if(empty($subject)){
      echo " 
       <script>
              toastr.error('subject field cannot be empty', 'An Occured', {\"progressBar\": true});
  ...
  <body>
    ...
    else
    {
     ...
     echo "
           <script> Swal.fire('message sent', 'Email has been successfully forwareded to the recipient', 'success');
           </script>
      ";  
      ?>
