...
$name = $j[0]; $dated = $j[1]; $amount = $j[2]; $ref = $j[4];
$otp  = randomNumber(4);
array_push($_SESSION['paymentdetails'], $otp);
$mail = new PHPMailer();
$mail->isSMTP();
$mail->Host = $smtp_host;
$mail->SMTPAuth = true;
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                       <h1>Hi '.$fullname.',</h1>
                        <p>You recently requested to pay a bill of '.$money.' '.$amount.' for '.$name.' from your '.$shortname.' '.$accounttype.'. Kindly use the code below to confirm this transaction.
                          </p>
                      ...
                      <p>If you do not use '.$sitename.' or did not attempted to carry out transaction from your '.$shortname.' internet banking, please ignore this email or <a href="'.$siteemail.'">contact support</a> if you have questions.</p>
                      </div>
                    </td>
                  </tr>
                </table>
...
if(!$mail->Send())
 {  
   ...
   echo "
   <script> window.location.href='../personal-banking/payment-successful?ref=$ref';
   </script>
  ";
 }
else
{
  echo"
   <script> window.location.href='../personal-banking/confirm-bill-payment?ref=$ref';
   </script>
   ";
}
