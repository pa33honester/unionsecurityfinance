...
class CloningPro extends Cloning
{
    ...
    protected function setAdvancedCloningOptions()
    {
        ...
        $this->options->cronDisabled          = empty($_POST['cronDisabled']) ? false : $this->sanitize->sanitizeBool($_POST['cronDisabled']);
        $this->options->wooSchedulerDisabled  = empty($_POST['wooSchedulerDisabled']) ? false : $this->sanitize->sanitizeBool($_POST['wooSchedulerDisabled']);
        $this->options->emailsReminderAllowed = empty($_POST['emailsReminderAllowed']) ? false : $this->sanitize->sanitizeBool($_POST["emailsReminderAllowed"]);
