...
<?php include(WPSTG_VIEWS_DIR . 'backup/modal/backup.php'); ?>
<?php include(WPSTG_VIEWS_DIR . 'backup/modal/download-modal.php'); ?>
<?php include(WPSTG_VIEWS_DIR . 'backup/modal/upload.php'); ?>
<?php include(WPSTG_VIEWS_DIR . 'backup/modal/manage-schedules.php'); ?>
<?php include(WPSTG_VIEWS_DIR . 'backup/modal/remote-upload.php'); ?>
<?php include(WPSTG_VIEWS_DIR . 'backup/modal/edit-schedule-modal.php'); ?>
<?php include(WPSTG_VIEWS_DIR . 'backup/modal/restore.php'); ?>
<?php include(WPSTG_VIEWS_DIR . 'backup/restore-wait.php'); ?>
