    ...
    <div>
        ...
        if ($isGoogleDriveAuthenticated) {
            ...
            <strong class="wpstg-mr-10px">
                <?php
                echo esc_html__('You are already authenticated to Google Drive.', 'wp-staging');
                ?>
                <br>
                <?php
                echo esc_html__('Remove storage settings to reconnect if you have uploading issues to Google Drive.', 'wp-staging');
                ?>
            </strong>
            </p>
