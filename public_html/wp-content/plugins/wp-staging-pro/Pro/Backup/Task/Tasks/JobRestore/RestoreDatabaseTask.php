...
class RestoreDatabaseTask extends BasicRestoreDatabaseTask
{
    ...
    protected function setupMultipartDatabaseRestore()
    {
        ...
        if ($metadata->getIsBackupFormatV1(false)) {
            ...
            $databasePart = $metadata->getMultipartMetadata()->getDatabaseFiles()[$databasePartIndex];
            $databaseFile = $this->pathIdentifier->transformIdentifiableToPath($databasePart);
        }
