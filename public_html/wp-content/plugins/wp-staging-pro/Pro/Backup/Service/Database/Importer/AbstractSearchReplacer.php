...
abstract class AbstractSearchReplacer implements DatabaseSearchReplacerInterface
{
    ...
    public function getSearchAndReplace(string $destinationSiteUrl, string $destinationHomeUrl, string $absPath = '', $destinationSiteUploadURL = null): SearchReplace
    {
        ...
        /** @var array */
        $searchReplaceToSort = $this->applyFilters('wpstg.backup.restore.searchreplace', $searchReplaceToSort, $absPath, $this->sourceSiteUrl, $this->sourceHomeUrl, $this->destinationSiteUrl, $this->destinationHomeUrl);
    ...
    protected function isExtraCslashEscapingRequired(): bool
    {
        ...
        $this->requireCslashEscaping = $this->applyFilters('wpstg.backup.restore.extended-cslash-search-replace', $requireCslashEscaping) === true;
