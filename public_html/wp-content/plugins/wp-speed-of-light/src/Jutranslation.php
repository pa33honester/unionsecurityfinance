...
class Jutranslation
{
    ...
    public static function getInput()
    {
        ...
        wp_enqueue_script('wpsol-bootstrap', plugins_url('assets/js/bootstrap.min.js', self::$main_plugin_file), array());
        wp_enqueue_script('jutranslation-bootbox', plugin_dir_url(self::$main_plugin_file) . 'jutranslation/assets/js/bootbox.js', array('jquery'));
