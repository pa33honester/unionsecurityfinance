 ...
 *
 * @package Joomunited\WPSOL\Jufeedback
 */

namespace Joomunited\WPSOL\Jufeedback;
...
class Jufeedback
{
    ...
    {
        // Get speed light configuration
        $wpsol_configuration = array(
    ...
    {
        //only show notice for administrator role
        if (!current_user_can('manage_options')) {
            return;
        }
        wp_enqueue_script(
